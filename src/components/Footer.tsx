        ...
        <div className="py-16 border-t border-white/10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <Link href="/" className="text-3xl font-bold tracking-tight text-white flex items-center gap-2 group">
              <div className="w-10 h-10 rounded-full bg-[#39FF14]/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                <div className="w-4 h-4 rounded-full bg-[#39FF14] shadow-[0_0_12px_#39FF14]"></div>
              </div>
          ...
          <div className="lg:col-span-3 flex flex-col gap-5">
            ...
            <div className="flex flex-wrap gap-3">
              {/* Twitter (X) SVG */}
              <a href="#" aria-label="Twitter" className="p-3.5 bg-brand-card/80 rounded-2xl hover:bg-[#39FF14] hover:text-[#021107] transition-all border border-white/10 group">
              ...
              {/* LinkedIn SVG */}
              <a href="#" aria-label="LinkedIn" className="p-3.5 bg-brand-card/80 rounded-2xl hover:bg-[#39FF14] hover:text-[#021107] transition-all border border-white/10 group">
                <svg className="h-5 w-5 text-slate-300 group-hover:text-[#021107]" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Instagram SVG */}
              <a href="#" aria-label="Instagram" className="p-3.5 bg-brand-card/80 rounded-2xl hover:bg-[#39FF14] hover:text-[#021107] transition-all border border-white/10 group">
                <svg className="h-5 w-5 text-slate-300 group-hover:text-[#021107]" viewBox="0 0 24 24" fill="currentColor">
